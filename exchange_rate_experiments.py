...
for horizon in horizons:
    ...
    scaled_trues = np.load("./Autoformer/results/" + folder + "/true_scaled.npy")
    scaled_valids = np.load("./Autoformer/results/" + folder + "/valid_scaled.npy")
...
metrics.to_csv("./Autoformer/test_results/naive_forecast_metrics.csv", index=False)